...
# ABmounds have 9 records with discrepant TopoIDs, where there is 0 in Bara there is a TopoID in Adela


## Length 
checklength <- if_else(abmounds$Length == abmounds$`Length (max, m)`, "equal", "nonequal")
checklength[checklength=="nonequal"] 
problemLength <- abmounds[which(checklength=="nonequal"),] 
problemLength %>% 
...
# SUMMARY
# We have 444 linked records between A and B, out of which 406 are meaningful mounds called abmounds here, and additional 11 potential mounds. 
...
# SUMMARY
# ab2010 - with 22% more mounds (493 vs 406) I expect more discrepancies in measurements height (how is that possible?) than abmounds
