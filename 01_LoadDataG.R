...
# Load the datasets
mounds_bara <- read_sheet("https://docs.google.com/spreadsheets/d/1YNylFmIQZ3oAIHdd2yxcHgre48J81K1nM0bhDG5j-bI/edit#gid=515219244")# 441 obs legacy data verification Bara version (streamlined manually in 2018) version
...
mounds_adela <- read_sheet("https://docs.google.com/spreadsheets/d/11pwAdDNS6bpVg1aAhuUuz_Lgcxsze8Z_afLxAVs99wc/edit#gid=1826731021") # 444 obs legacy data verification Adela (original 2017 but streamlined in Open Refine with LU supplied by and dimensions verified via GoogleEarth) version
mnd2017 <- read_sheet("https://docs.google.com/spreadsheets/d/1TyWsxAbRTqOBnim7Asg8qmYqlMcvV7Q0ZuBtWKCntdE/edit#gid=433356722")
mnd2018 <- read_sheet("https://docs.google.com/spreadsheets/d/1XCgQqd7ooP4CrDYQ2EmhR3_P1VDFpYlyTxywTB3PqWI/edit#gid=1326323943") # 282 records cleaned in OR from annotations
mnd2009<- read_sheet("https://docs.google.com/spreadsheets/d/1FqqVPbK263RoOVEgSzvmQTi6U7xz5jekTvLCg1qMaEE/edit#gid=0") # this file contains 2009 survey and RS mounds that Adela check in GEPro (exists on GDrive)
