...
```{r load-Y-vector}
# Load vectors
bg_border <- st_read("../raw_data/Vectors/Bulgaria_Border.shp")
Y_towns <- st_read("../raw_data/Vectors/Modern_settlements_Yambol_TRAP.shp")
Y_region <- st_read("../raw_data/Vectors/YamRegion.shp")
Y_towns_poly <- read_sf("../raw_data/Vectors/YamTownpoly/Yam_towns_poly.shp")
```
